                                ...
                                <div class="card-body">
                                    <form id="general-form" class="col-md-12" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <x-form.textarea labelName="Address" name="address" required="required"
                                            ...
                                            <div class="form-group col-md-8">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="suffix" name="currency_position"
                                            ...
                                            <x-form.selectbox labelName="Timezone" name="timezone" col="col-md-8"
                                                class="selectpicker">
                                            ...
                                            <x-form.selectbox labelName="Date Format" name="date_format" col="col-md-8"
                                                class="selectpicker">
                                                <option value="F j, Y"
                                            ...
                                            <x-form.textbox labelName="Invoice Prefix" name="invoice_prefix"
                                                required="required" value="{{ config('settings.invoice_prefix') }}"
                                                col="col-md-8" placeholder="Enter invoice prefix" />

                                            <x-form.textbox labelName="Invoice Number" name="invoice_number"
                                                required="required" value="{{ config('settings.invoice_number') }}"
                                    ...
                                    <form id="mail-form" class="col-md-12" method="post">
                                        ...
                                        <div class="row">
                                            <x-form.selectbox labelName="Mail Driver (Protocol)" name="mail_mailer"
                                                required="required" col="col-md-8" class="selectpicker">
                                            ...
                                            <x-form.textbox labelName="Mail Address" name="mail_username"
                                                required="required" value="{{ config('settings.mail_username') }}"
                                                col="col-md-8" placeholder="Enter mail username" />
                                            <x-form.textbox labelName="Password" name="mail_password"
                                                required="required" value="{{ config('settings.mail_password') }}"
                                                col="col-md-8" placeholder="Enter mail password" />
                                            <x-form.textbox labelName="Mail From Name" name="mail_from_name"
                                                required="required" value="{{ config('settings.mail_from_name') }}"
                                                col="col-md-8" placeholder="Enter mail password" />
                                        ...
                                        <div class="form-group col-md-12">
                                            <button type="reset" class="btn btn-danger btn-sm">Reset</button>
                                            <button type="button" class="btn btn-primary btn-sm" id="mail-save-btn"
                                                onclick="save_data('mail')">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
