                                    ...
                                    <ul class="nav nav-tabs flex-column" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#general-setting"
                                                role="tab" aria-controls="general-setting" aria-selected="true">General
                                                Setting
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <form id="general-form" class="col-md-12" method="post"
                                                    ...
                                                    <div class="row">
                                                        <x-form.textbox labelName="Title" name="title"
                                                            required="required" value="{{ config('settings.title') }}"
                                                            col="col-md-8" placeholder="Enter title" />
                                                        <x-form.textarea labelName="Address" name="address"
                                                            required="required" value="{{ config('settings.address') }}"
                                                        ...
                                                        <x-form.textbox labelName="Currency Symbol"
                                        ...
                                        <div id="mail-setting" class="tab-pane">
                                            <div class="card-body">
                                                <form id="mail-form" class="col-md-12" method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <x-form.selectbox labelName="Mail Driver (Protocol)"
                                                            name="mail_mailer" required="required" col="col-md-8"
                                                            class="selectpicker">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <button type="reset"
                                                            class="btn btn-danger btn-sm">Reset</button>
                                                        <button type="button" class="btn btn-primary btn-sm"
                                                            id="mail-save-btn" onclick="save_data('mail')">Save</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                ...
                success: function (data) {
                    ...
                    if (data.status == false) {
                        $.each(data.errors, function (key, value) {
                            ...
                            $('#' + form_id + '-form select#' + key).parent().addClass(
                                'is-invalid');
