        ...
        <div class="col-xl-5 col-md-12">
            ...
            <div class="dt-card dt-card__full-height">
                ...
                <div class="dt-card__header">
                    ...
                    <!-- Card Tools -->
                    <div class="dt-card__tools">
                        <a href="javascript:void(0)" class="dt-card__more"><i class="icon icon-add-circle mr-2"></i>Add
                            New
                            Account</a>
                    </div>
                    <!-- /card tools -->
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-6 pr-2">
                                        ...
                                        <div class="dt-avatar-wrapper">
                                            <!-- Avatar -->
                                            <img class="dt-avatar size-30" src="assets/images/user-avatar/nikki.jpg"
                                                alt="Mila Alba">
                                            <!-- /avatar -->
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-6 pr-2">
                                        ...
                                        <div class="dt-avatar-wrapper">
                                            <!-- Avatar -->
                                            <img class="dt-avatar size-30" src="assets/images/user-avatar/amay.jpg"
                                                alt="Dinesh Suthar">
                                            <!-- /avatar -->
                                    ...
                                    <div class="col-6 pr-2">
                                        ...
                                        <div class="dt-avatar-wrapper">
                                            ...
                                            <img class="dt-avatar size-30"
                                                src="assets/images/user-avatar/garry-sobars.jpg" alt="Pukhraj">
                                            <!-- /avatar -->
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-6 pr-2">
                                        ...
                                        <div class="dt-avatar-wrapper">
                                            <!-- Avatar -->
                                            <img class="dt-avatar size-30"
                                                src="assets/images/user-avatar/domnic-harris.jpg" alt="crish Harris">
                                            <!-- /avatar -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <a href="javascript:void(0)" class="d-inline-block mb-2">
                                        <img src="assets/images/dashboard/google-play-store.png" alt="Play Store"
                                            class="img-fluid">
                                    </a> <a href="javascript:void(0)" class="d-inline-block">
                                        <img src="assets/images/dashboard/apple-app-store.png" alt="App Store"
                                            class="img-fluid"> </a>
                                </div>
                                <!-- /grid item -->
                    ...
                    <div class="media-list">
                        ...
                        <div class="media media-news">
                            ...
                            <img class="img-fluid rounded-xl"
                                src="assets/images/dashboard/bitcoin-cryptocurrency-trader.jpg" alt="Crypto Currency">
                            <!-- /image -->
