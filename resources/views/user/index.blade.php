                            ...
                            <div class="dt-card__body">
                                ...
                                <form id="form-filter">
                                    <div class="row">
                                        ...
                                        <x-form.textbox labelName="Email" name="email" col="col-md-4"
                                            placeholder="Enter email" />
                                        <x-form.textbox labelName="Mobile No" name="mobile_no" col="col-md-4"
                                            placeholder="Enter mobile no" />
                                        <x-form.selectbox labelName="Role" name="role_id" col="col-md-4"
                                            class="selectpicker">
                                            @foreach ($roles as $role)
                                            <option value="{{ $role->id }}">{{ $role->role_name }}</option>
                                            @endforeach
                                        </x-form.selectbox>
                                        <x-form.selectbox labelName="Status" name="status" col="col-md-4"
                                            class="selectpicker">
